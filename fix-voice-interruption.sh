#!/bin/bash
echo "Fixing Voice Interruption Feature"
echo "================================="

# Create the fixed file
cat << 'EOF' > /tmp/voice-handsfree-fixed.html
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
scp /tmp/voice-handsfree-fixed.html root@146.190.39.214:/tmp/

ssh root@146.190.39.214 << 'REMOTE'
cd /var/www/smart-doc-v2

# Backup current file
cp templates/voice-handsfree.html templates/voice-handsfree.html.bak

# Apply the fix
cp /tmp/voice-handsfree-fixed.html templates/voice-handsfree.html

# Restart the app
pm2 restart smart-doc-v2

echo "✅ Voice interruption feature fixed!"
