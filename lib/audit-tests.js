...
async function testContent($, brand) {
    ...
    if (inventoryLinks.length > 0) {
        ...
        issues.push({
            title: 'Manually review inventory visibility',
            details: 'Inventory links not easily found',
            priority: 'high',
    ...
    if (contactLinks.length > 0) {
        ...
        issues.push({
            title: 'Manually verify contact information visibility',
            details: 'Contact information links not found',
            priority: 'high',
    ...
    tests.push({ name: 'Business Hours', value: hasHours ? 'Found' : 'Not Found' });
    if (hasHours) {
        score += 1;
    } else {
        issues.push({
            title: 'Business hours not visible on homepage',
            details: 'Business hours not found',
            priority: 'high',
...
async function testLeadGeneration($) {
    ...
    if (forms.length > 0) {
        ...
        issues.push({
            ...
            details: 'No contact forms found on homepage',
            priority: 'high',
