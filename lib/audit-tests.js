...
async function testUserExperience($) {
    ...
    if (hasTelLinks || hasLabeledPhone || hasPhoneInHeader || hasCallNow || (hasPhoneAnywhere && hasAddress)) {
        ...
        issues.push({
            ...
            details: 'Automated analysis could not verify phone number placement. Manual review recommended. Most dealerships display phone numbers prominently in the header with department-specific numbers (Sales, Service, Parts).',
            priority: 'low',
            category: 'User Experience - Contact',
        ...
        issues.push({
            ...
            details: 'Add visible phone number and/or email address in header or prominent location. Industry standard is to display department numbers (Sales, Service, Parts) in the header.',
            priority: 'medium',
            category: 'User Experience - Contact'
        });
    }
