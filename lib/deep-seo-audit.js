        ...
        try {
            ...
            try {
                ...
                await driver.wait(async () => {
                    const linkCount = await driver.findElements(By.css('a[href]:not([href="#"]):not([href=""])')).then(links => links.length);
                    console.log(`[Selenium] Current link count: ${linkCount}`);
                    return linkCount > 5; // Dealership sites typically have many nav links
