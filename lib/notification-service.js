/**
 * Auto Audit Pro - Notification Service
...
class NotificationService {
    ...
    async sendAlert(profile, alert) {
        ...
        try {
            // Parse alert preferences if it's a string
            ...
            if (alertPrefs.email && profile.alert_email) {
            ...
            if (alertPrefs.sms && profile.alert_phone && alert.alert_level === 'RED') {
